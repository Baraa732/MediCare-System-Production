 ...
 *
 * This file is required for browser (web) push notifications.
 */
...
async function initMessaging() {
  ...
  const res = await fetch('/api/notifications/push/web-config', {
    credentials: 'include',
  });
  if (!res.ok) return;
  ...
  messaging.onBackgroundMessage((message) => {
    ...
    const tag = message.data?.category || 'medicare-secretary';
