...
export function LivePushToast() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-3 z-[80] flex justify-center px-4">
      <div className="pointer-events-auto flex w-full max-w-lg items-start gap-3 rounded-2xl border border-blue-200 bg-white px-4 py-3 shadow-xl shadow-blue-900/10">
