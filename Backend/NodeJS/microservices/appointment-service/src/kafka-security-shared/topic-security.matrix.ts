...
export const KAFKA_TOPIC_SECURITY_MATRIX: TopicSecurityEntry[] = [
  ...
  { topic: 'appointment.created', producers: ['appointment-service'], consumers: ['notification-service', 'reminder-service', 'emr-service'], requiresTenantCorroboration: true, requiresIdempotency: true },
  ...
  { topic: 'appointment.completed', producers: ['appointment-service'], consumers: ['reminder-service', 'emr-service'], requiresTenantCorroboration: true, requiresIdempotency: true },
