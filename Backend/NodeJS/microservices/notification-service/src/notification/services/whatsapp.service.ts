...
export class WhatsAppService {
  ...
  async sendAppointmentCancelled(
    ...
    const message = `❌ Appointment Cancelled\n\nDear ${patientName},\n\nYour appointment with Dr. ${doctorName} on ${appointmentDate} at ${appointmentTime} at ${clinicName} has been cancelled.\n\nContact the clinic to rebook if needed.\n\nThank you!`;
    return this.sendMessage(this.instanceName, phoneNumber, message);
  }
  ...
  async sendAppointmentRescheduled(
    ...
    const message = `🔄 Appointment Rescheduled\n\nDear ${patientName},\n\nYour appointment with Dr. ${doctorName} has been updated to:\n📅 Date: ${appointmentDate}\n⏰ Time: ${appointmentTime}\n🏥 Clinic: ${clinicName}\n\nPlease arrive 15 minutes early.\n\nThank you!`;
    return this.sendMessage(this.instanceName, phoneNumber, message);
  }
}
