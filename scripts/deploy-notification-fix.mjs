...
const SERVICES = [
  ['appointment-service', SERVICE_IDS['appointment-service']],
  ['notification-service', SERVICE_IDS['notification-service']],
  ['reminder-service', SERVICE_IDS['reminder-service']],
];
...
if (!EXPECTED) throw new Error('Pass commit hash');

const token = await loadToken();
console.log(`Deploying notification path services for commit ${EXPECTED}…`);
